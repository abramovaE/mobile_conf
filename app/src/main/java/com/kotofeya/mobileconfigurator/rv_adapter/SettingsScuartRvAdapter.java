...
public class SettingsScuartRvAdapter extends RvAdapter {
    ...
    public void onBindViewHolder(@NonNull RvAdapter.ViewHolder holder, int position) {
        ...
        linearLayout.setOnClickListener(configListener(FragmentHandler.TRANSIVER_SETTINGS_SCUART_FRAGMENT, transiver.getSsid()));
    }
}
