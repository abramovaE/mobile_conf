...
import static com.kotofeya.mobileconfigurator.presentation.activities.MainActivity.HOTSPOT_DIALOG_TAG;
...
//        Logger.d(TAG, "mainMenuInterfaces(): " + interfaces);
        ...
        binding.hotspotSettingsBtn.setOnClickListener( v-> {
            ((MainActivity)requireActivity()).launchHotspotSettings();
        }
//                MainActivity.HotSpotSettingsDialog dialog = new MainActivity.HotSpotSettingsDialog();
