...
import com.kotofeya.mobileconfigurator.presentation.fragments.update.os.UpdateOsFragmentVM;
...
public class ConfigTransportFragment  extends Fragment implements AdapterListener {
    ...
    public void adapterItemOnClick(Transceiver transceiver) {
        Logger.d(TAG, "adapterItemOnClick(), transceiver: " + transceiver.getIp()
                + " " + transceiver.getSsid());
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        rvAdapter = RvAdapterFactory.getRvAdapter(RvAdapterType.CONFIG_TRANSPORT,
                new ArrayList<>(), this);
